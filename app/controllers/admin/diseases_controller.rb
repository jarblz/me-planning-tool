class Admin::DiseasesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @disease.save
        format.html { redirect_to admin_diseases_url, notice: 'Disease was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @disease.update(disease_params)
        format.html { redirect_to admin_diseases_url, notice: 'Disease was successfully updated.' }
  ...
  def destroy
    @disease.destroy
    respond_to do |format|
      format.html { redirect_to admin_diseases_url, notice: 'Disease was successfully destroyed.' }
